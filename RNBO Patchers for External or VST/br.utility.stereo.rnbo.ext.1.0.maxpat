...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 456.75, 104.0, 41.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.5, 86.0, 27.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 400.75, 104.0, 41.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.5, 24.0, 27.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ 0 ],
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 293.0, 32.0, 70.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 293.0, 66.0, 94.0, 86.0 ],
					"saved_attribute_attributes" : 					{
						"activebgoncolor" : 						{
...
, 							{
								...
								"index" : 3,
								"tag" : "in3",
								"comment" : "(int) mode: 0 = Stereo, 1 = Swap,  2 = Left, 3 = Right, 4 = Mid, 5 = Side"
							}
, 							{
								"type" : "event",
								"index" : 4,
								"tag" : "in4",
								"comment" : "(float) pan, -100. to 100."
							}
, 							{
								"type" : "event",
								"index" : 5,
								"tag" : "in5",
								"comment" : "(float) width:  100 to 100."
							}
 ]
					}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 513.0, 98.0, 229.0, 23.0 ],
									"rnbo_classname" : "in",
...
,
										...
										"outputs" : [ 											{
												...
												"displayName" : "(float) pan, -100. to 100.",
												"docked" : 0
											}
 ],
										"helpname" : "in",
...
,
									"text" : "in 4 @comment \"(float) pan, -100. to 100.\"",
									"varname" : "pan"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 583.0, 149.0, 235.0, 23.0 ],
									"rnbo_classname" : "in",
									"rnbo_extra_attributes" : 									{
										"meta" : ""
									}
...
,
										...
										"outputs" : [ 											{
												...
												"displayName" : "(float) width:  100 to 100.",
												"docked" : 0
											}
 ],
										"helpname" : "in",
...
,
									"text" : "in 5 @comment \"(float) width:  100 to 100.\"",
									"varname" : "width"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 225.0, 61.0, 467.0, 23.0 ],
									"rnbo_classname" : "in",
									"rnbo_extra_attributes" : 									{
										"meta" : ""
									}
...
,
										...
										"outputs" : [ 											{
												...
												"displayName" : "(int) mode: 0 = Stereo, 1 = Swap,  2 = Left, 3 = Right, 4 = Mid, 5 = Side",
												"docked" : 0
											}
 ],
										"helpname" : "in",
...
,
									"text" : "in 3 @comment \"(int) mode: 0 = Stereo, 1 = Swap,  2 = Left, 3 = Right, 4 = Mid, 5 = Side\"",
									"varname" : "mode"
								}
...
,
							"max-export" : 							{
								"max-external-export" : 								{
									"external_name" : "br.utility.stereo.1.0~",
									"author" : "Brian Riordan",
									"description" : "This is a basic external for Max/MSP that allows the user to adjust mix of a stereo signal, such as swapping, left only, right only, mid, or side. Additionally, the user can adjust the width or the pan of the resulting signal.Currently works in any sample rate or bit depth.",
									"mc" : 1
								}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-18" : [ "live.dial[1]", "Panning", 0 ],
			"obj-19" : [ "live.dial[2]", "Width", 0 ],
			"obj-35" : [ "rnbo~", "rnbo~", 0 ],
